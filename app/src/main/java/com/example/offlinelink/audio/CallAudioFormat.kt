...
const val CALL_AUDIO_LYRA_SAMPLE_RATE_HZ = 16_000
...
const val CALL_AUDIO_LYRA_MIME_TYPE = "audio/lyra;rate=16000;bitrate=3200"
...
fun isStreamingCallAudioMimeType(mimeType: String): Boolean =
  mimeType.trim().let {
    it.startsWith("audio/pcm", ignoreCase = true) ||
      ...
      it.startsWith("audio/lyra", ignoreCase = true)
  }
